# while loop
# a while loop excutes a block of code repeatedly as long as a certain condition is true 
...
print('==============================')
#below is a decreament example that prints the mutiples of  3 starting from 201 to 150
